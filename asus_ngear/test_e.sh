...
#BF 2x2 80 MHz Power Levels 10, 13, 16, 20 dBm 5 GHz
...
#BF 1x1 80 MHz Power Levels 10, 13, 16, 20 dBm 5 GHz
...
#No BF 3x3 80 MHz Power Levels 10, 16, 20 dBm 5 GHz
bf="nobf"; bw="80"; band="5g"; ant="3x3"
exec_cmd $DUTA bf_off
exec_cmd $DUTA chbw 48 80
exec_cmd $DUTA 3x3
run_test

#No BF 2x2 80 MHz Power Levels 10, 13, 16, 20 dBm 5 GHz
bf="nobf"; bw="80"; band="5g"; ant="2x2"
exec_cmd $DUTA bf_off
exec_cmd $DUTA chbw 48 80
exec_cmd $DUTA 2x2
run_test

#No BF 1x1 80 MHz Power Levels 10, 13, 16, 20 dBm 5 GHz
bf="nobf"; bw="80"; band="5g"; ant="1x1"
exec_cmd $DUTA bf_off
exec_cmd $DUTA chbw 48 80
exec_cmd $DUTA 1x1
run_test
